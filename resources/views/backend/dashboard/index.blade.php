...
<div class="d-flex align-items-center p-4 mt-2">
    ...
    <div class="ml-auto">
        <button class="btn btn-danger text-white btn-rounded py-2 px-3">Next <i
    ...
    <div class="col-md-12 col-lg-4">
        <div class="card">
            <div class="d-flex align-items-center px-3 py-4 border-bottom">
                ...
                <div class="ml-auto">
                    <button class="btn btn-danger text-white btn-rounded" data-toggle="modal" data-target="#addtask">Add
                        Task</button>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <ul class="list-task todo-list list-group mb-0" data-role="tasklist">
                        <li class="list-group-item todo-item pt-0" data-role="task">
                            ...
                            <ul class="list-style-none assignedto mt-2">
                                <li class="assignee"><img class="assignee-img"
                                        src="{{asset('assets/images/users/1.jpg')}}" alt="user" data-toggle="tooltip"
                                        data-placement="top" title="" data-original-title="Steave"></li>
                                <li class="assignee"><img class="assignee-img"
                                        src="{{asset('assets/images/users/2.jpg')}}" alt="user" data-toggle="tooltip"
                                        data-placement="top" title="" data-original-title="Jessica"></li>
                                <li class="assignee"><img class="assignee-img"
                                        src="{{asset('assets/images/users/3.jpg')}}" alt="user" data-toggle="tooltip"
                                        data-placement="top" title="" data-original-title="Priyanka"></li>
                                <li class="assignee"><img class="assignee-img"
                                        src="{{asset('assets/images/users/4.jpg')}}" alt="user" data-toggle="tooltip"
                            ...
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label todo-label" for="customCheck1">
                                    <span class="todo-desc">Give Purchase report to</span><span
                                        class="badge badge-pill badge-danger font-medium text-white ml-1">Today
                                    </span>
                                </label>
                            </div>
                            <ul class="list-style-none assignedto mt-2">
                        ...
                        <li class="list-group-item todo-item" data-role="task">
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label todo-label" for="customCheck4">
                                    <span class="todo-desc">Forward all tasks</span> <span
                                        class="badge badge-pill badge-warning ml-1 text-white font-medium">2
                                        weeks</span>
                                </label>
                            </div>
                            <div class="item-date"> 26 jun 2017</div>
                        ...
                        <li class="list-group-item todo-item pb-0" data-role="task">
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label todo-label" for="customCheck6">
                                    <span class="todo-desc">Important tasks</span><span
                                        class="badge badge-pill badge-success font-medium text-white ml-1">2
                                        weeks </span>
                                </label>
                            </div>
                            <ul class="list-style-none assignedto mt-2">
    ...
    <div class="col-md-6 col-lg-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="mt-3 font-light">Titudin venenatis ipsum ac feugiat. Vestibulum ullamcorper
                    quam.</p>
                <button class="btn btn-success btn-rounded waves-effect waves-light mt-2 text-white">Read
                    more</button>
            </div>
        </div>
    </div>
            ...
            <div class="card-body scrollable" style="height: 598px;">
                <div class="steamline mt-0">
                    <div class="sl-item">
                        ...
                        <div class="sl-right">
                            <div><a href="javascript:void(0)" class="link text-dark">John Doe</a> <span
                    ...
                    <div class="sl-item">
                        ...
                        <div class="sl-right">
                            <div><a href="javascript:void(0)" class="link text-dark">Hritik Roshan</a>
                    ...
                    <div class="sl-item">
                        <div class="sl-left"> <img src="{{asset('assets/images/users/1.jpg')}}" alt="user"
                                class="rounded-circle" /> </div>
                        <div class="sl-right">
                            <div><a href="javascript:void(0)" class="link text-dark">Gohn Doe</a> <span
                                    class="sl-date">5 minutes ago</span>
                    ...
                    <div class="sl-item">
                        <div class="sl-left"> <img src="{{asset('assets/images/users/2.jpg')}}" alt="user"
                                class="rounded-circle" /> </div>
                        <div class="sl-right">
                            <div><a href="javascript:void(0)" class="link text-dark">Varun Dhavan</a>
                                <span class="sl-date">5 minutes ago</span>
                    ...
                    <div class="sl-item">
                        <div class="sl-left"> <img src="{{asset('assets/images/users/5.jpg')}}" alt="user"
                                class="rounded-circle" /> </div>
                        <div class="sl-right">
                            <div><a href="javascript:void(0)" class="link text-dark">Tiger Sroff</a>
                                <span class="sl-date">5 minutes ago</span>
        ...
        <div class="card">
                        ...
                        <li class="odd chat-item">
                            <div class="chat-content">
                                <div class="box bg-light-success">
                                    ...
                                    <p class="font-light mb-0">Hi, How are you Sonu? ur next concert?
                                    </p>
            ...
            <div class="card-body border-top">
                <div class="row">
                    ...
                    <div class="col-3">
                        <a class="btn-circle btn-lg btn-success float-right text-white" href="javascript:void(0)"><i
