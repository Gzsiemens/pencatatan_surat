                    ...
                    <div class="card-body">
                        ...
                        <form class="mt-4">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="total_dokumen">Jumlah Dokumen yang Diperlukan</label>
                                        <input class="form-control" type="number" id="total_dokumen" readonly required name="total_dokumen" value="{{ !empty($pertanyaan->total_docs) ? $pertanyaan->total_docs : 0 }}"/>
                                    </div>
                                </div>
                            </div>
