...
class PertanyaanController extends Controller
{
    ...
    {
        $pertanyaan = Question::withCount('dokumen')->get();
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $docs = $request->get('total_dokumen');

            $question = new Question();
            $question->name = $pertanyaan;
            $question->total_docs = $docs;
            $question->save();
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($validator->fails()) {
            ...
            $jawaban = $request->get('jawaban');
            $pertanyaan = $request->get('pertanyaan');
            $total_dokumen = $request->get('total_dokumen');
            $jawaban_id = $request->get('jawaban_id');

            $question =  Question::findOrFail($id);
            $question->name = $pertanyaan;
            $question->total_docs = $total_dokumen;
            $question->save();
